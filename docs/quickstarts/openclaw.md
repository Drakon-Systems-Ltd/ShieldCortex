...
Every local feature is free — no trial, no licence key. Full cloud sync for this OpenClaw box is Enterprise (sales@drakonsystems.com); the cloud free tier (audit metadata, 500 scans/month) just needs your email.
