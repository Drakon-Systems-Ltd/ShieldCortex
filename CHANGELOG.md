...
- Doctor honesty warnings no longer print `$ shieldcortex memories import-native` or `$ shieldcortex repair`. Those stay for real failures. Warn-only NEXT is filtered the same way. Guard stays off.
