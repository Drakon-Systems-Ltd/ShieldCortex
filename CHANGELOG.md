...
### Added
- **Design:** ADR-002 provenance-first enforcement, v2 (Status: Proposed; session taint, floor redefined by irreversibility, measured narrowing; folds the #556 author-side objections). Docs only, no behaviour change — `docs/architecture/ADR-002-provenance-first-enforcement.md`
