  ...
  return (
    <GlassCard strong className="p-6">
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-lg font-semibold text-[var(--sc-text)]">Welcome to ShieldCortex</h3>
      </div>
      <p className="mt-2 max-w-2xl text-sm text-[var(--sc-text-dim)]">
        Nothing here yet. The dashboard is for <strong className="text-[var(--sc-text)]">visual
        review and bulk decisions</strong>; the <code className="font-mono">shieldcortex</code> CLI and
        the agent hooks are for <strong className="text-[var(--sc-text)]">automation</strong>.
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-3">
        <div className="rounded-xl border border-[var(--sc-border)] bg-[var(--sc-surface-2)] p-4">
          <Database size={16} className="text-[var(--sc-ok)]" />
          <p className="mt-2 text-sm font-medium text-[var(--sc-text)]">Capture memories</p>
        ...
        <div className="rounded-xl border border-[var(--sc-border)] bg-[var(--sc-surface-2)] p-4">
          <Terminal size={16} className="text-[var(--sc-ok)]" />
          <p className="mt-2 text-sm font-medium text-[var(--sc-text)]">Generate audit data</p>
          <p className="mt-1 text-xs text-[var(--sc-text-muted)]">
